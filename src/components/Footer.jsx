  ...
  return (
    <footer className="relative mt-24 border-t border-slate-200/50 dark:border-white/5 bg-white/70 dark:bg-slate-950/80 backdrop-blur-md z-10">
      ...
      <div className="max-w-5xl mx-auto py-12 px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h3 className="text-slate-900 dark:text-white text-xl font-bold tracking-tight" style={{ fontFamily: 'Archivo, sans-serif' }}>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-sm" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
        ...
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 text-center flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
          <p>© {currentYear} Haikal Mabrur. All Rights Reserved.</p>
          <div className="flex gap-4">
            <span className="text-slate-400 dark:text-slate-600">Built with React & GSAP</span>
            <span className="text-slate-400 dark:text-slate-600">Liquid Glass System 3.0</span>
          </div>
        </div>
      </div>
    </footer>
